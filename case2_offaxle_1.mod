...
param TN == 0.25; # tractor 前悬
param TL == 1.5; # tractor 轴距
param TM == 0.25; # tractor 后悬 == c1
param TB == 1; # tractor/trailer 宽度

param L2 == 3; # 连轴长度==L2

param TT1 == 1; # trailer 前悬
param TT2 == 1; # trailer 后悬==c2
...
(AX[NE,pp] - terminal_config[1])^2 <= 8^2; ## 8*1.3由终点矩形确定，16*2.6足够容纳5个车
